<div class="sidebar js-scrollable" id="sidebar">
  <div class="sidebar-menu">
    <a href="projects/<%- slug %>" class="sidebar-menu--item project-special">
      ...
      <span class="item-name" id="project-title">Project “<%- name %>”</span>
    </a>

    <a href="projects/<%- slug %>" class="sidebar-menu--item">
      <i class="item-icon fa fa-file-text-o"></i>
      <span class="item-name">Resources</span>
    </a>

    <a href="projects/<%- slug %>/translate" class="sidebar-menu--item editor-special">
